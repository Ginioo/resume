            ...
            <div className="col-lg-8">
              <div className="row">
                <div className="col-lg-12">
                  <p>I graduated from <a href="http://english.csie.tku.edu.tw/">Tamkang University</a> and my major is
                  ...
                  <p>
                    ...
                    including admin panels, which are built up on top of a self-developed framework using php 5.3 and I
                    was
                  ...
                  <p>Moreover, part of my role was responsible for learning new tech stacks such as git for version
                    control,
                    nightwatchjs for test-automation, and then to introduce them to my colleagues. We went through each
                    of
                    our projects using kanban board, which is a way to run a project within a team or between teams.
                  </p>
                  <p>
                    From 2 May 2017 to 30 Sep 2017, I worked for the <a href="https://www.bloomon.nl">Bloomon</a>
                    platform
                  ...
                  <p>
                    ...
                    before, I can learn it as quickly as I can. I'm highly interested in this trainee program. Please
                    give
